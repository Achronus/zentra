...
from zentra_models.validation.constants import (
...
from zentra_models.validation.core import data_array_validation
...
class Block(BaseModel):
    ...
    def block_start_str(self) -> str:
        """Returns a string for the start of the component block."""
        # TODO: add props
