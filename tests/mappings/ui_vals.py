...
PAGINATION_VALID_VALS = {
    "content": {
        "simple": '<Pagination>\n<PaginationContent>\n<PaginationItem>\n<PaginationPrevious className={pagStartIndex === 0 ? "pointer-events-none opacity-50" : undefined} onClick={() => {\npagSetStartIndex(pagStartIndex - itemsPerPage);\npagSetEndIndex(pagEndIndex - itemsPerPage);\n}} />\n</PaginationItem>\n<PaginationItem>\n<PaginationLink href="#" isActive>\n1\n</PaginationLink>\n</PaginationItem>\n<PaginationItem>\n<PaginationLink href="#">\n2\n</PaginationLink>\n</PaginationItem>\n<PaginationItem>\n<PaginationLink href="#">\n3\n</PaginationLink>\n</PaginationItem>\n<PaginationItem>\n<PaginationNext className={pagEndIndex === maxItems ? "pointer-events-none opacity-50" : undefined} onClick={() => {\npagSetStartIndex(pagStartIndex + itemsPerPage);\npagSetEndIndex(pagEndIndex + itemsPerPage);\n}} />\n</PaginationItem>\n</PaginationContent>\n</Pagination>',
        "full": '<Pagination>\n<PaginationContent>\n<PaginationItem>\n<PaginationPrevious className={pagStartIndex === 0 ? "pointer-events-none opacity-50" : undefined} onClick={() => {\npagSetStartIndex(pagStartIndex - itemsPerPage);\npagSetEndIndex(pagEndIndex - itemsPerPage);\n}} />\n</PaginationItem>\n<PaginationItem>\n<PaginationLink href="#" isActive>\n1\n</PaginationLink>\n</PaginationItem>\n<PaginationItem>\n<PaginationLink href="#">\n2\n</PaginationLink>\n</PaginationItem>\n<PaginationItem>\n<PaginationLink href="#">\n3\n</PaginationLink>\n</PaginationItem>\n<PaginationItem>\n<PaginationEllipsis />\n</PaginationItem>\n<PaginationItem>\n<PaginationNext className={pagEndIndex === maxItems ? "pointer-events-none opacity-50" : undefined} onClick={() => {\npagSetStartIndex(pagStartIndex + itemsPerPage);\npagSetEndIndex(pagEndIndex + itemsPerPage);\n}} />\n</PaginationItem>\n</PaginationContent>\n</Pagination>',
    },
    "logic": {
...
ALERT_DIALOG_VALID_VALS = {
    "content": {
        ...
        "no_buttons": '<AlertDialog>\n<AlertDialogTrigger asChild>\n<Button variant="outline">\nShow Dialog\n</Button>\n</AlertDialogTrigger>\n<AlertDialogContent>\n<AlertDialogHeader>\n<AlertDialogTitle>\nAre you absolutely sure?\n</AlertDialogTitle>\n<AlertDialogDescription>\nThis action cannot be undone. This will permanently delete your account and remove your data from our servers.\n</AlertDialogDescription>\n</AlertDialogHeader>\n</AlertDialogContent>\n</AlertDialog>',
        "trigger_text": "<AlertDialog>\n<AlertDialogTrigger>\nShow Dialog\n</AlertDialogTrigger>\n<AlertDialogContent>\n<AlertDialogHeader>\nAre you absolutely sure?\n</AlertDialogHeader>\n</AlertDialogContent>\n</AlertDialog>",
        "text_content": '<AlertDialog>\n<AlertDialogTrigger asChild>\n<Button variant="outline">\nShow Dialog\n</Button>\n</AlertDialogTrigger>\n<AlertDialogContent>\n<AlertDialogHeader>\nAre you absolutely sure?\n</AlertDialogHeader>\n<AlertDialogFooter>\nThis is a string footer.\n</AlertDialogFooter>\n</AlertDialogContent>\n</AlertDialog>',
    },
}
...
DROPDOWN_MENU_VALID_VALS = {
    "content": {
        "radio_group": '<DropdownMenu>\n<DropdownMenuTrigger asChild>\n<Button variant="outline">\nopen\n</Button>\n</DropdownMenuTrigger>\n<DropdownMenuContent className="w-56">\n<DropdownMenuLabel>\nPanel Position\n</DropdownMenuLabel>\n<DropdownMenuSeparator />\n<DropdownMenuRadioGroup value={ddPosition} onValueChange={ddSetPosition}>\n<DropdownMenuRadioItem value="top-position">\nTop Position\n</DropdownMenuRadioItem>\n<DropdownMenuRadioItem value="bottom-position">\nBottom Position\n</DropdownMenuRadioItem>\n<DropdownMenuRadioItem value="right-position">\nRight Position\n</DropdownMenuRadioItem>\n</DropdownMenuRadioGroup>\n</DropdownMenuContent>\n</DropdownMenu>',
    ...
    "logic": {
        "radio_group": 'const [ddPosition, ddSetPosition] = useState("top-position");',
        "checkbox": "const [showStatusBar, setShowStatusBar] = useState(true);\nconst [showActivityBar, setShowActivityBar] = useState(false);\nconst [showPanel, setShowPanel] = useState(false);",
        "str_list": "",
        "full": "",
    },
}
