...
from zentra_models.core.validation import key_attr_validation
...
class Div(HTMLTag):
    ...
    - `content` (`string | ZentraModel | list[string | ZentraModel]`) - Can be either:
      ...
      3. Any `zentra.models.core.js.JSIterable` model, such as `zentra.models.core.js.Map`
      4. A `list` of a combination of `strings` of text, `zentra.models.core.html.HTMLTag` models, `zentra.models.core.js.JSIterable` models, or `zentra.models.core.Component` models
...
class FigCaption(HTMLTag):
    ...
    Parameters:
    - `text` (`string | zentra.models.core.html.HTMLContent | list[string | zentra.models.core.html.HTMLContent]`) - the text to put into the caption. Can either be:
      ...
      2. A `zentra.models.core.html.HTMLContent` object for wrapping the text in a `heading`, `paragraph`, or `span` tag
      3. A `list` of combined `string` and `zentra.models.core.html.HTMLContent` objects for more advanced captions
    - `styles` (`string, optional`) - the CSS styles to apply to the tag. `None` by default

    Example Usage:
    1. Advanced captioning.
    ```python
    from zentra.models.core.html import FigCaption, HTMLContent
...
class Figure(HTMLTag):
    ...
    Parameters:
    - `img` (`zentra.models.nextjs.Image`) - a NextJS `Image` component defining the image to display in the figure
    - `caption` (`zentra.models.core.html.FigCaption`) - a `FigCaption` component representing the caption of the Image
    - `styles` (`string, optional`) - the CSS styles to apply to the tag. `None` by default
