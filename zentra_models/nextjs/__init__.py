...
from zentra_models.base.library import NextJs
...
class UrlQuery(BaseModel, NextJs):
    ...
    ```python
    from zentra.models.nextjs import Url
...
class StaticImage(BaseModel, NextJs):
    ...
    1. A profile picture.
    ```python
    from zentra.models.nextjs import StaticImage
...
class Image(Component, NextJs):
    ...
    ```python
    from zentra.models.nextjs import Image, StaticImage
...
class Link(Component, NextJs):
    ...
    Parameters:
    - `href` (`string | zentra.models.nextjs.UrlQuery`) - a path or URL to navigate to starting with any of the following:
      1. Local paths - `/`, `./`, or `../`
      2. File urls - `ftp://` or `file://`
      3. Informative urls - `mailto:` or `tel:`
      4. HTTP urls - `http://` or `https://`
      5. Or, a `zentra.models.nextjs.UrlQuery` model
    ...
    1. A simple link.
    ```python
    from zentra.models.nextjs import Link
    ...
    ```python
    from zentra.models.nextjs import Link, UrlQuery
