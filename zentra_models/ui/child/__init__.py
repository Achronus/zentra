...
from zentra_models.core.enums.child import (
    ActionVariant,
    CancelVariant,
    ContentVariant,
    DescriptionVariant,
...
from zentra_models.core.utils import name_to_pascal_case, str_to_list

from zentra_models.ui import ShadcnUi
from zentra_models.ui.control import Button
from zentra_models.ui.child.utils import (
    full_container,
    simple_container,
    str_attr,
)
...
class TriggerModel(ChildModel):
    ...
    - `content` (`zentra.models.ui.control.Button | string | zentra.models.ui.child.ValueModel`) - the item to add to the trigger. Can be either:
