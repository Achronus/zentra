...
from zentra_models.core import Component, DataArray
...
class Button(Component, ShadcnUi):
    ...
    Parameters:
    - `content` (`string | zentra.models.core.react.LucideIconWithText`) - the information displayed inside the button. Can be a string of text or a `LucideIconWithText` Zentra model. Can include parameter variables (indicated by starting the variable name with a `$.`)
...
class Combobox(Component, ShadcnUi):
    ...
    Parameters:
    - `data` (`zentra.models.core.DataArray`) -
    - `display_text` (`string`) -
    - `search_text` (`string`) -
...
class DatePicker(Component, ShadcnUi):
    ...
    Built using a composition of the `zentra.models.ui.modal.Popover` and `zentra.models.ui.control.Calendar` models.

    Parameters:
    - `trigger` (`string`) - the text to display in the trigger button
    - `content` (`zentra.models.ui.control.Calendar`) - a zentra `Calendar` model
...
class RadioButton(Component, ShadcnUi):
    ...
    Used inside a `zentra.models.ui.control.RadioGroup` component.
...
class RadioGroup(Component, ShadcnUi):
    ...
    Parameters:
    - `items` (`list[RadioButton]`) - a list of `zentra.models.control.RadioButton`
...
class ScrollArea(Component, ShadcnUi):
    ...
    Parameters:
    - `content` (`string | zentra.models.core.html.Div`) - Can be either:
      1. A simple `string` of text
      2. A `zentra.models.core.html.Div` model (recommended)
    ...
    ```python
    from zentra.models.core.html import Figure, FigCaption, Div, HTMLContent
    from zentra.models.core.js import Map
    from zentra.models.nextjs import Image
    from zentra.models.ui.control import ScrollArea
    ...
    ```python
    from zentra.models.core.html import Div, HTMLContent
    from zentra.models.core.js import Map

    from zentra.models.ui.control import ScrollArea
    from zentra.models.ui.presentation import Separator
...
class SelectGroup(Component, ShadcnUi):
    ...
    Used inside the `zentra.models.ui.control.Select` component.
...
class Select(Component, ShadcnUi):
    ...
    - `groups` (`SelectGroup | list[zentra.models.model.control.SelectGroup]`) - a single or list of `zentra.models.model.control.SelectGroup` models containing the `SelectItem` values
    """
...
class Toggle(Component, ShadcnUi):
    ...
    Parameters:
    - `content` (`string | zentra.models.core.react.LucideIcon`) - the information displayed inside the toggle. Can be a string of text or a `LucideIcon` Zentra model. Can include parameter variables (indicated by starting the variable name with a `$.`)
...
class ToggleGroup(Component, ShadcnUi):
    ...
    Parameters:
    - `items` (`list[zentra.models.ui.control.Toggle]`) - a list of `Toggle` models to display in the group
