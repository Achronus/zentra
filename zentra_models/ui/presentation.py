...
from zentra_models.core.enums.ui import (
    BadgeVariant,
    Orientation,
    SkeletonPreset,
    ToggleType,
)
from zentra_models.core.validation import check_pattern_match, url_validation
from zentra_models.core.validation.component import (
...
class AccordionItem(Component, ShadcnUi):
    ...
    Cannot be used on its own, must be used inside a `zentra.models.ui.presentation.Accordion` model.
...
class Accordion(Component, ShadcnUi):
    ...
    Parameters:
    - `items` (`list[zentra.models.ui.presentation.AccordionItems]`) - a list of `AccordionItem` models
...
class AspectRatio(Component, ShadcnUi):
    ...
    Parameters:
    - `img` (`zentra.models.nextjs.Image`) - the `Image` model to use inside the aspect ratio
...
class Avatar(Component, ShadcnUi):
    ...
    Parameters:
    - `src` (`string | zentra.models.nextjs.StaticImage`) - can be either:
        ...
        5. Or a parameter, signified by a `$.` at the start of the parameter name. Parameters are useful when using the `Image` inside an `iterable` function like `zentra.models.js.Map`
...
class SkeletonShell(Component, ShadcnUi):
    ...
    Cannot be used on its own, must be used inside a `zentra.models.ui.presentation.Skeleton` or `zentra.models.ui.presentation.SkeletonGroup` model.
...
class SkeletonGroup(Component, ShadcnUi):
    ...
    Cannot be used on its own, must be used inside a `zentra.models.ui.presentation.Skeleton` model.
    ...
    - `items` (`list[zentra.models.ui.presentation.SkeletonShell]`) - a list of `SkeletonShell` models to use in the group
    """
...
class Skeleton(Component, ShadcnUi):
    ...
    - `items` (`zentra.models.ui.presentation.SkeletonShell | zentra.models.ui.presentation.SkeletonGroup | list[zentra.models.ui.presentation.SkeletonShell | zentra.models.ui.presentation.SkeletonGroup], optional`) - Can only be used when `preset="custom"`. Can be either:
    ...
    ```python
    from zentra.models.ui.presentation import Skeleton
    ...
    ```python
    from zentra.models.ui.presentation import Skeleton, SkeletonShell
...
class TableCell(Component, ShadcnUi):
    ...
    Cannot be used on its own, must be used inside a `zentra.models.ui.presentation.Table` or `zentra.models.ui.presentation.TableMap` model.
...
class TableRow(Component, ShadcnUi):
    ...
    Cannot be used on its own, must be used inside a `zentra.models.ui.presentation.Table` model.

    Parameters:
    - `cells` (`list[string | zentra.models.ui.presentation.TableCell`]) - A list of strings or `TableCell` models containing the body content. When `string` can include parameter variables (indicated by starting the variable name with a `$.`)
...
class TableMapRow(TableRow, ShadcnUi):
    ...
    Cannot be used on its own, must be used inside a `zentra.models.ui.presentation.TableMap` model.

    Parameters:
    - `cells` (`list[string | zentra.models.ui.presentation.TableCell`]) - A list of strings or `TableCell` models containing the body content. Cell text is automatically converted to a parameter string and prepended with the `param_name`
    - `key` (`string | integer, optional`) - an optional unique identifier for each row. Added to the `key` prop. `None` by default
    """
...
class Table(Component, ShadcnUi):
    ...
    Parameters:
    - `headings` (`list[string | zentra.models.ui.presentation.TableCell]`) - a list of strings or `TableCell` models defining the `TableHeads` for the table columns
    - `body` (`list[zentra.models.ui.presentation.TableRow] | zentra.models.ui.presentation.TableMap`) - can be either:
    ...
    - `footer` (`list[string | zentra.models.ui.presentation.TableCell], optional`) - a list of strings or `TableCell` models containing the footer content. `None` by default
